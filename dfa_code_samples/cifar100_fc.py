...
l4 = FeedbackFC(size=[3072, 1000], num_classes=100, sparse=args.sparse, rank=args.rank, name='fc1_fb')
...
l7 = FeedbackFC(size=[1000, 1000], num_classes=100, sparse=args.sparse, rank=args.rank, name='fc2_fb')
...
l10 = FeedbackFC(size=[1000, 1000], num_classes=100, sparse=args.sparse, rank=args.rank, name='fc3_fb')

l11 = FullyConnected(input_shape=1000, size=100, init=args.init, bias=args.bias, name='fc4')
